 ...
 * Попугай в клетке
 *
 * Блокирует два удара любой силы, после чего клетка ломается, попугай вылетает, забирает рендомный предмет у
 * противника и улетает с ним. Если ничего нет, то просто улетает.
 *
 * @type {module.GoldenCrown}
 */
module.exports = class Parrot extends Helmet {

  constructor() {
    super();

    this.uuid = 'c404c6e0-40f6-11e8-bcae-41e5ecbe4e9d';
    /**

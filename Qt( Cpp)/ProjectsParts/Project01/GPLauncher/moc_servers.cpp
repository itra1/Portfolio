...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Servers_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Servers_t qt_meta_stringdata_Servers = {
    {
QT_MOC_LITERAL(0, 0, 7), // "Servers"
QT_MOC_LITERAL(1, 8, 11), // "OnSetServer"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "Servers\0OnSetServer\0"
};
...
void Servers::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Servers *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->OnSetServer(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Servers::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Servers::OnSetServer)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Servers::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Servers.data,
    qt_meta_data_Servers,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Servers::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Servers.stringdata0))

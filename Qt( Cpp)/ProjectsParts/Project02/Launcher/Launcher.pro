...
QT += core quick gui svg webengine network # #network #webengine widgets xml quickcontrols2
CONFIG += c++11
...
SOURCES = \
    ...
    $$PWD/gui/forms/FooterLoginBlock.qml \
    $$PWD/gui/forms/HeaderWindowControl.qml \
    $$PWD/gui/forms/HeaderUserBlock.qml \
    $$PWD/gui/forms/VersionChange.qml \
    $$PWD/gui/forms/License.qml \
    $$PWD/gui/forms/Loader.qml \
    $$PWD/gui/forms/main.qml \
    $$PWD/gui/forms/ProgressLine.qml \
    $$PWD/gui/forms/PopapWarning.qml \

...
namespace Utils
{
    namespace Fs
    {
        ...
        void removeNoListFile(QString sourcePath, QString rootFolder, QStringList actualFilesList, QStringList excludeList);
        QList<QString> recursiveReadFilesInFolder(QString path);

...
{
	[SocketAction("cameras_remove")]
	public class CamerasRemove : IncomingMaterialAction
	{
		...
		public override bool Process()
		{
			...
			MessageDispatcher.SendMessage(this, MessageType.CameraRemove, _material, EnumMessageDelay.IMMEDIATE);
			return true;
		}
	}
}
...
{
	[SocketAction("cameras_update")]
	public class CamerasUpdate : IncomingMaterialAction
	{
		...
		public override bool Process()
		{
			...
			_material = Materials.UpdateOrAdd(_material);
			MessageDispatcher.SendMessage(this, MessageType.CameraUpdate, _material, EnumMessageDelay.IMMEDIATE);
			return true;
		}
	}
}
...
{
	[SocketAction("desktop_unload")]
	public class DesktopUnload : IncomingAction
	{
		...
		public override bool Process()
		{
			...
			MessageDispatcher.SendMessage(this, MessageType.DesktopUnload, _desktopId, EnumMessageDelay.IMMEDIATE);
			return true;
		}
	}
}
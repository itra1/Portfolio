...
{
	[SocketAction("status_preload")]
	public class StatusPreload : IncomingAction
	{
		...
		public override bool Process()
		{
			...
			MessageDispatcher.SendMessage(this, MessageType.StatusPreload, _statusId, EnumMessageDelay.IMMEDIATE);
			return true;
		}
	}
}
...
{
	[SocketAction("stopwatch_start")]
	public class StopwatchStart : IncomingAction
	{
		...
		public override bool Process()
		{
			...
			MessageDispatcher.SendMessage(this, MessageType.StopwatchStart, this, EnumMessageDelay.IMMEDIATE);
			return true;
		}
	}
}
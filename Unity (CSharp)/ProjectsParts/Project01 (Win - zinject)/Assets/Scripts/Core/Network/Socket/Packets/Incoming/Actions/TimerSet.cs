...
{
	[SocketAction("set_timer")]
	public class TimerSet : IncomingAction
	{
		...
		public override bool Parse()
		{
			...
			if (Content.ContainsKey(IncomingPacketDataKey.Time))
				Time = Content.GetLong(IncomingPacketDataKey.Time);
		...
		public override bool Process()
		{
			...
			MessageDispatcher.SendMessage(this, MessageType.TimerSet, this, EnumMessageDelay.IMMEDIATE);
			return true;
		}
	}
}
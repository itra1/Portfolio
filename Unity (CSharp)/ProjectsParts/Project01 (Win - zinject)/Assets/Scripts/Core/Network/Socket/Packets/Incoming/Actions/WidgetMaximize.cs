...
{
	[SocketAction("widget_extend")]
	public class WidgetMaximize : IncomingAction
	{
		...
		public override bool Process()
		{
			...
			MessageDispatcher.SendMessage(this, MessageType.WidgetMaximize, _widgetId, EnumMessageDelay.IMMEDIATE);
			return true;
		}
	}
}
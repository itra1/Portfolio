...
{
    [MaterialData(typeof(MsPowerPointDocumentMaterialData))]
    public class MsPowerPointDocumentPresenterAdapter : MsOfficeDocumentPresenterAdapterBase<MsPowerPointDocumentPresenter>
    {

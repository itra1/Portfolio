...
{
    public class DraggableMouseCursorUpdater : MouseCursorUpdaterBase,
        ...
        IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        public virtual void OnPointerEnter(PointerEventData eventData)
        {
            if (!eventData.dragging)
                MouseCursorAccess.Set(MouseCursorState.Hand, this);
        }
        ...
        {
            MouseCursorAccess.Set(MouseCursorState.Grab, this);
        }

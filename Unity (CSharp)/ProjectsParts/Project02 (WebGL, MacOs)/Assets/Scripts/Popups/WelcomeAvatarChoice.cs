...
public class WelcomeAvatarChoice : MonoBehaviour
{
    ...
    [SerializeField] private SelectAvatarUI selectAvatarUI;
    ...
    public void Start()
    {
        ...
        if(Flag) StartCoroutine(SetFlagImage((int)userInfo.country.id));
    ...
    public void SetAvatartPreview(ulong avatarId, string avatarUri)
    {

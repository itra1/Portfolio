...
namespace Newtonsoft.Json.Utilities
{
	...
	internal static class DynamicWrapper
	{
		...
		private static void Init()
		{
			if (_moduleBuilder == null)
			{
				lock (_lock)
				{
					if (_moduleBuilder == null)
					{
						var assemblyName = new AssemblyName("Newtonsoft.Json.Dynamic");
		...
		{
			var name = "Newtonsoft.Json.Dynamic.snk";
	...
	internal class WrapperMethodBuilder
	{
		...
		public void Generate(MethodInfo newMethod)
		{
			...
			var srcField = typeof(DynamicWrapperBase).GetField("UnderlyingObject", BindingFlags.Instance | BindingFlags.NonPublic);

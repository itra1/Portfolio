...
namespace it.Game.Gamera.Motors
{
  ...
  public abstract class YawPitchMotor : CameraMotor
  {
	 ...
	 //private bool _viewActivateOnly = false;
	 //protected bool ViewActivateOnly { get => _viewActivateOnly; set => _viewActivateOnly = value; }
	 ...
	 public virtual Vector3 GetFrameEuler(bool rUseYawLimits, bool rUsePitchLimits = true)
	 {
		...
		else
		{
		  ...
		  if (lInputSource.IsViewingActivated/* || !ViewActivateOnly*/)
		  {
	 ...
	 public override bool OnInspectorGUI()
	 {
		...
		//if (EditorHelper.BoolField(ViewActivateOnly, "View Activate Only", RigController, 16f))
		//{
		//  lIsDirty = true;
		//  ViewActivateOnly = EditorHelper.FieldBoolValue;
		//}
		//EditorGUILayout.LabelField(new GUIContent("View Activate Only", "Right mouse button click activate"));

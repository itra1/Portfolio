...
namespace it.Game.Player.MotionControllers.Motions
{
  ...
  public class FallPastel : JumpPastel
  {
	 ...
	 public FallPastel(MotionController rController)
		  : base(rController)
	 {
		_Priority = 20;
		_IsControlEnabled = false;
	 ...
	 public override bool Activate(MotionControllerMotion rPrevMotion)
	 {
		...
		mActorController.AccumulatedVelocity = mActorController.State.Velocity;

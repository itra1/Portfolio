...
{
  [MotionName("Form3Activator")]
  public class Form3Activator : MotionControllerMotion
  {
    private int _actualForm = 2;
    private float _speedEnergyChange = 2;
    private float _priceEnergy = 10;
    public Form3Activator() : base()
    {
      _Pack = Idle.GroupName();
      _Category = EnumMotionCategories.PLAYER;

      _Priority = 200;
      _ActionAlias = "PlayerForm3";
    ...
    public Form3Activator(MotionController rController) : base(rController)
    {
      _Pack = Idle.GroupName();
      _Category = EnumMotionCategories.PLAYER;
    ...
    public override bool Activate(MotionControllerMotion rPrevMotion)
    {
      ...
      //mMotionController.CurrentForm = 2;
      //dress.SetDress(2);
    ...
    public void PlayerSpecialChange(bool activateForm, UnityEngine.Events.UnityAction onMiddle = null)
    {
      ...
      PostProcessManager.Instance.ActiveSpecial2(activateForm, () =>
      {
        onMiddle?.Invoke();

...
namespace it.Game.Player.MotionControllers.Motions
{
  /// <summary>
  /// </summary>
  [MotionName("Walk Run Pivot Pastel")]
  ...
  public class WalkRunPivot : MotionControllerMotion, IWalkRunMotion, IPivotMotion
  {
	 ...
	 public bool _walkOnly = false;
	 public virtual bool WalkOnly
	 {
	 ...
	 public override bool Activate(MotionControllerMotion rPrevMotion)
	 {
		...
		if (rPrevMotion is RunningJump || rPrevMotion is RunningJump_v3)
		{
		...
		mActorController.SetVelocity(Vector3.zero);
	 ...
	 public override bool OnInspectorGUI()
	 {
		...
		if (EditorHelper.BoolField("Walk only", "Walk only", WalkOnly, mMotionController))
		{
		  lIsDirty = true;
		  WalkOnly = EditorHelper.FieldBoolValue;
		}

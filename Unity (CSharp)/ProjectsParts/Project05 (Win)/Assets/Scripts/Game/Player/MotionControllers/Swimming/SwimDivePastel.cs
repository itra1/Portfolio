...
namespace it.Game.Player.MotionControllers.Motions
{
  ...
  /// </summary>
  [MotionName("Swim Dive Pastel")]
  [MotionDescription("Swim Dive Pastel")]
  public class SwimDivePastel : MotionControllerMotion
  {
	 ...
	 /// <summary>
	 /// Swimmer info associated with SwimIdlePastel
	 /// </summary>
	 ...
	 /// </summary>
	 protected SwimPivotPastel mSwimPivot = null;

	 /// <summary>
	 /// Default constructor
	 /// </summary>
	 public SwimDivePastel()
			 : base()
	 {
	 ...
	 public SwimDivePastel(MotionController rController)
			 : base(rController)
	 {
		_Pack = SwimIdlePastel.GroupName();
		_Category = EnumMotionCategories.JUMP;
	 ...
	 public override bool TestActivate()
	 {
		...
		if (mMotionController._InputSource != null && mMotionController._InputSource.IsJustPressed(ActionAlias))
		{
		  ...
		  if (mSwimPivot == null) { mSwimPivot = mMotionController.GetMotion<SwimPivotPastel>(); }
	 ...
	 {
		m13726 = FindAnimationClip("Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Animations/Mixamo/ybot@Run To Dive.fbx/run_to_dive.anim", "mixamo.com");
		m17380 = FindAnimationClip("Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Animations/Mixamo/ybot@Swimming.fbx/SwimIdlePose.anim", "SwimIdlePose");
		m18078 = FindAnimationClip("Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Animations/Mixamo/ybot@Dive Roll.fbx/StandingDive.anim", "StandingDive");
	 ...
	 public override void OnSettingsGUI()
	 {
		...
		m13726 = CreateAnimationField("run_to_dive", "Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Animations/Mixamo/ybot@Run To Dive.fbx/run_to_dive.anim", "mixamo.com", m13726);
		m17380 = CreateAnimationField("SwimIdlePose", "Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Animations/Mixamo/ybot@Swimming.fbx/SwimIdlePose.anim", "SwimIdlePose", m17380);
		m18078 = CreateAnimationField("StandingDive", "Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Animations/Mixamo/ybot@Dive Roll.fbx/StandingDive.anim", "StandingDive", m18078);

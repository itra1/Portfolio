...
namespace it.Game.Player.MotionControllers.Motions
{
  ...
  /// Бездействие в воде
  /// </summary>
  [MotionName("Swim Idle Pastel")]
  public class SwimIdlePastel : MotionControllerMotion
  {
	 ...
	 /// </summary>
	 [NonSerialized]
	 public SwimInfo SwimmerInfo = null;
	 ...
	 public SwimIdlePastel(MotionController rController)
		  : base(rController)
	 {
		_Pack = GroupName();
		_Category = EnumMotionCategories.IDLE;
	 ...
	 public override bool TestActivate()
	 {
		...
		//if (mMotionController.ActiveMotion == null)
		//  return false;
	 ...
	 {
		RipplesPrefab = UnityEditor.AssetDatabase.LoadAssetAtPath<GameObject>("Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Resources/Prefabs/SurfaceRipples.prefab");
		SplashPrefab = UnityEditor.AssetDatabase.LoadAssetAtPath<GameObject>("Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Resources/Prefabs/SurfaceSplash.prefab");
		UnderwaterPrefab = UnityEditor.AssetDatabase.LoadAssetAtPath<GameObject>("Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Resources/Prefabs/Underwater.prefab");
	 }
	 ...
	 public static bool OnPackInspector(MotionController rMotionController)
	 {
		...
		if (GUILayout.Button(new GUIContent("Setup Pack", "Create and setup the motion pack."), EditorStyles.miniButton))
		{
		  ...
		  if (sCreateMotions || sCreateSubStateMachines)
		  {
			 ...
			 SwimIdlePastel lIdle = rMotionController.CreateMotion<SwimIdlePastel>(0);
			 ...
			 SwimDivePastel lDive = rMotionController.CreateMotion<SwimDivePastel>(0);
			 ...
			 SwimPivotPastel lStrafe = rMotionController.CreateMotion<SwimPivotPastel>(0);
			 ...
			 SwimExitPastel lExit = rMotionController.CreateMotion<SwimExitPastel>(0);
	 ...
	 public override void OnSettingsGUI()
	 {
		...
		m15642 = CreateAnimationField("treading_water", "Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Animations/Mixamo/ybot@Treading Water.fbx/treading_water.anim", "mixamo.com", m15642);

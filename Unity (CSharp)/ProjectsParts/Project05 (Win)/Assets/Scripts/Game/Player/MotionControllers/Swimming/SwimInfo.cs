...
namespace it.Game.Player.MotionControllers.Motions
{
  ...
  public delegate void SwimDelegate(SwimInfo rSwimmer);
  ...
  public class SwimInfo
  {
	 ...
	 /// </summary>
	 public SwimDelegate OnSwimEnter = null;

	 /// <summary>
	 /// Delegate for callbacks to the swimmer
	 /// </summary>
	 public SwimDelegate OnSwimExit = null;
...
#if USE_MESSAGE_DISPATCHER || OOTII_MD || OOTII_MD
		com.ootii.Messages.MessageDispatcher.SendMessage(mActorController.gameObject, "SWIM_ENTER", this, 0f);
#endif

#if USE_BONE_CONTROLLER || OOTII_BC
		BoneController lBoneController = mActorController.gameObject.GetComponent<BoneController>();
		if (lBoneController != null)
		{
		  lBoneController.EnableMotors<FootGround2BoneMotor>(false);
		}
#endif
	 }
	 ...
	 public void ExitWater()
	 {
		...
		if (lBoneController != null)
		{
		  lBoneController.EnableMotors<FootGround2BoneMotor>(true);
		}
#endif
	 ...
	 /// <returns></returns>
	 public static SwimInfo GetSwimmerInfo(Transform rTransform)
	 {
		...
		SwimIdlePastel lMotion = lMotionController.GetMotion<SwimIdlePastel>();

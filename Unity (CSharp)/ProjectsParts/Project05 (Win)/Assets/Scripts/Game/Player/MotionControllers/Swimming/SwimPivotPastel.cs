...
namespace it.Game.Player.MotionControllers.Motions
{
  ...
  [MotionName("Swim Pivot Pastel")]
  [MotionDescription("Swim Pivot Pastel")]
  public class SwimPivotPastel : MotionControllerMotion
  {
	 /// <summary>
	 /// Values to average
	 /// </summary>
	 ...
	 /// Default constructor
	 /// </summary>
	 public SwimPivotPastel()
		  : base()
	 {
		_Pack = SwimIdlePastel.GroupName();
	 ...
	 public SwimPivotPastel(MotionController rController)
		  : base(rController)
	 {
		_Pack = SwimIdlePastel.GroupName();
		_Category = EnumMotionCategories.WALK;
	 ...
	 {
		m15640 = FindAnimationClip("Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Animations/Mixamo/ybot@Treading Water.fbx/TreadIdlePose.anim", "TreadIdlePose");
		m15642 = FindAnimationClip("Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Animations/Mixamo/ybot@Treading Water.fbx/treading_water.anim", "mixamo.com");
		m17384 = FindAnimationClip("Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Animations/Mixamo/ybot@Swimming.fbx", "mixamo.com");
		m17382 = FindAnimationClip("Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Animations/Mixamo/ybot@Swimming.fbx/SwimLeft.anim", "SwimLeft");
		m17386 = FindAnimationClip("Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Animations/Mixamo/ybot@Swimming.fbx/SwimRight.anim", "SwimRight");
		m14222 = FindAnimationClip("Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Idling/unity_Idle_IdleToIdlesR.fbx/IdlePose.anim", "IdlePose");
	 ...
	 public override void OnSettingsGUI()
	 {
		...
		m15640 = CreateAnimationField("TreadIdlePose", "Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Animations/Mixamo/ybot@Treading Water.fbx/TreadIdlePose.anim", "TreadIdlePose", m15640);
		m15642 = CreateAnimationField("Swim Tree.treading_water", "Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Animations/Mixamo/ybot@Treading Water.fbx/treading_water.anim", "mixamo.com", m15642);
		m17384 = CreateAnimationField("Swim Tree.swimming", "Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Animations/Mixamo/ybot@Swimming.fbx/swimming.anim", "mixamo.com", m17384);
		m17382 = CreateAnimationField("Swim Tree.SwimLeft", "Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Animations/Mixamo/ybot@Swimming.fbx/SwimLeft.anim", "SwimLeft", m17382);
		m17386 = CreateAnimationField("Swim Tree.SwimRight", "Assets/ootii/Assets/MotionControllerPacks/Swimming/Content/Animations/Mixamo/ybot@Swimming.fbx/SwimRight.anim", "SwimRight", m17386);
		m14222 = CreateAnimationField("IdlePose", "Assets/ootii/Assets/MotionController/Content/Animations/Humanoid/Idling/unity_Idle_IdleToIdlesR.fbx/IdlePose.anim", "IdlePose", m14222);

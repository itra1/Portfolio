...
public class TutorialPointer : Singleton<TutorialPointer> {
	...
	private List<WordIsland> _wordList;
	...
	private void OnMoveComplete() {
		...
		_wordList = _wordList = new List<WordIsland>(word.gameIsland.wordIslandList).FindAll(x => !x.isOpen);
	...
	private void PlayMove() {
		...
		_wordList = new List<WordIsland>(word.gameIsland.wordIslandList);

...
public class SplashUi : UiPanel {
	...
	IEnumerator CheckReady() {
		...
		while(PlayerManager.Instance.company.saveCompanies.Count == 0 || PlayerManager.Instance.company.saveCompanies[0].locations.Count == 0 || PlayerManager.Instance.company.saveCompanies[0].locations[0].levels.Count == 0)

...
/// <summary>
/// Генератор платформ в режиме выживания
/// </summary>
[Serializable]
public class PlatformSpawnerSurvival : IPlatformSpawner {
  ...
  public GameObject Spawn(Vector3 pos, PlatformType platformType = PlatformType.none) {

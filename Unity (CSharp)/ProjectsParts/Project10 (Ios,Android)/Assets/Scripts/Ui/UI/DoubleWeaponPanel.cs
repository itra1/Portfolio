...
public class DoubleWeaponPanel : PanelUi {
	...
	protected override void OnEnable() {
		...
		title.text = LanguageManager.GetTranslate("run_UseDoubleWeapon");
		sec = LanguageManager.GetTranslate("run_Sec");

		int ressurectionCount =  PlayerPrefs.GetInt("doubleWeapon");
	...
	public void ButtonOk() {
		...
		//RunnerController.instance.SetDoubleWeapon();

...
public class PlayGamePlay: UiPanel, ICoinsPanelParent, IMiniMenuParent {
  ...
  public List<GameObject> defObjectList;
  public List<GameObject> bonusObjectList;
  ...
  protected override void Awake() {
    ...
    if (UnityEngine.iOS.Device.generation == UnityEngine.iOS.DeviceGeneration.iPhoneX) {
      pauseButton.GetComponent<RectTransform>().anchoredPosition = new Vector2(0, -50);
      bonusButton.anchoredPosition = new Vector2(0, -50);
      anyLetterHintButton.anchoredPosition = new Vector2(0, 50);
      firstLetterHintButton.anchoredPosition = new Vector2(0, 50);
    }
#endif
  }
  ...
  protected override void OnEnable() {
    ...
    defObjectList.ForEach(x => x.SetActive(!PlayerManager.Instance.company.isBonusLevel));
    bonusObjectList.ForEach(x => x.SetActive(PlayerManager.Instance.company.isBonusLevel));
  ...
  public void PauseButton() {
    ...
    if (PlayerManager.Instance.company.isBonusLevel) {
      ...
      DailyBonusCancelUi panel = UIManager.Instance.GetPanel<DailyBonusCancelUi>();
  ...
  public void StartConchMover(Vector3 pos) {
    ...
    cm.SetMover(conchIcon, () => {
      conchIcon.GetComponent<HorseShoeUi>().AddNew();
    });
  }

  public void SetCounchPointer(bool isActive, Action OnClickCallback) {
    conchIcon.GetComponent<HorseShoeUi>().SetPointer(isActive, OnClickCallback);
  }
  ...
  public GameObject gameMiniMenu {
    get {
  ...
  private CoinsMover GetInstanceCoinshMover() {
    ...
    Debug.Log("GetInstanceCoinshMover");
  ...
  public void CoinsPanelGiftOpen() {
    coinsPanel.GetComponent<CoinsWidget>().animComponent.Play("show");

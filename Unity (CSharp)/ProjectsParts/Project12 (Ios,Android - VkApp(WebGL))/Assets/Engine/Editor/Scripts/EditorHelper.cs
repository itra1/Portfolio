...
namespace Game.Editor
{
	public static class EditorHelper
	{
		...
		public static void SetDirty(UnityEngine.Object obj)
		{
			...
			if (obj is Component)
			{
				_ = EditorSceneManager.MarkSceneDirty((obj as Component).gameObject.scene);
			}
			else if (obj is GameObject)
			{
				_ = EditorSceneManager.MarkSceneDirty((obj as GameObject).scene);
			}
			else if (!EditorUtility.IsPersistent(obj))
			{
				_ = EditorSceneManager.MarkSceneDirty(SceneManager.GetActiveScene());
			}
			else
			{

...
{
	public class CreateDownNoteAction : TimelineAction
	{
		public override bool Execute(ActionContext context)
		{
			...
			var assetPath = AssetDatabase.FindAssets("SwipeNoteDown t:ScriptableObject")[0];
		...
		[TimelineShortcut("Create Down Note", KeyCode.S)]
		public static void HandleShortCut(ShortcutArguments args)
		{
			_ = Invoker.InvokeWithSelected<CreateDownNoteAction>();
		}
	}
}

...
{
	public class CreateLeftNoteAction : TimelineAction
	{
		public override bool Execute(ActionContext context)
		{
			...
			var assetPath = AssetDatabase.FindAssets("SwipeNoteLeft t:ScriptableObject")[0];
		...
		[TimelineShortcut("Create Left Note", KeyCode.A)]
		public static void HandleShortCut(ShortcutArguments args)
		{
			_ = Invoker.InvokeWithSelected<CreateLeftNoteAction>();
		}
	}
}

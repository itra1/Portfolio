...
{
	public class CreateRightNoteAction : TimelineAction
	{
		public override bool Execute(ActionContext context)
		{
			...
			var assetPath = AssetDatabase.FindAssets("SwipeNoteRight t:ScriptableObject")[0];
		...
		[TimelineShortcut("Create Right Note", KeyCode.D)]
		public static void HandleShortCut(ShortcutArguments args)
		{
			_ = Invoker.InvokeWithSelected<CreateRightNoteAction>();
		}
	}
}

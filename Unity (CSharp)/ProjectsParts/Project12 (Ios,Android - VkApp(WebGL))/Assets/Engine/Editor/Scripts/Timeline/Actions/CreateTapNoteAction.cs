...
{
	public class CreateTapNoteAction : TimelineAction
	{
		public override bool Execute(ActionContext context)
		{
			...
			var assetPath = AssetDatabase.FindAssets("TapNote t:ScriptableObject")[0];
		...
		[TimelineShortcut("Create Tap Note", KeyCode.Q)]
		public static void HandleShortCut(ShortcutArguments args)
		{
			_ = Invoker.InvokeWithSelected<CreateTapNoteAction>();
		}
	}
}

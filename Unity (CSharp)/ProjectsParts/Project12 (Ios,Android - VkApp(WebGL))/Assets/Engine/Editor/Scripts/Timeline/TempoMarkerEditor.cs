...
namespace Game.Editor.TimeLine
{
	...
	{
		public static readonly string _defaultOnBeatMarkerSettings = "Assets/Engine/Editor/DefaultOnBeatMarkerSettings.asset";
		public static readonly string _defaultOffBeatMarkerSettings = "Assets/Engine/Editor/DefaultOffBeatMarkerSettings.asset";
		public static readonly string _defaultQuarterBeatMarkerSettings = "Assets/Engine/Editor/DefaultQuarterBeatMarkerSettings.asset";
		public static readonly string _defaultOctoBeatMarkerSettings = "Assets/Engine/Editor/DefaultOctoBeatMarkerSettings.asset";
		...
		public override void DrawOverlay(IMarker marker, MarkerUIStates uiState, MarkerOverlayRegion region)
		{
			...
			if (markerEditorSettings == null)
			{
				if (tempoMarker.ID == 0)
				{
					markerEditorSettings = (TempoMarkerEditorSettings) AssetDatabase.LoadAssetAtPath(_defaultOnBeatMarkerSettings, typeof(TempoMarkerEditorSettings));
				}
				else if (tempoMarker.ID == 1)
				{
					markerEditorSettings = (TempoMarkerEditorSettings) AssetDatabase.LoadAssetAtPath(_defaultOffBeatMarkerSettings, typeof(TempoMarkerEditorSettings));
				}
				else if (tempoMarker.ID == 2)
				{
					markerEditorSettings = (TempoMarkerEditorSettings) AssetDatabase.LoadAssetAtPath(_defaultQuarterBeatMarkerSettings, typeof(TempoMarkerEditorSettings));
				}
				else if (tempoMarker.ID == 3)
				{
					markerEditorSettings = (TempoMarkerEditorSettings) AssetDatabase.LoadAssetAtPath(_defaultOctoBeatMarkerSettings, typeof(TempoMarkerEditorSettings));
				}

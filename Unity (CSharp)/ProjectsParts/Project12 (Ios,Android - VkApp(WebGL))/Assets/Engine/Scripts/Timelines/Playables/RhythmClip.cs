...
namespace Engine.Scripts.Timelines.Playables
{
	...
	public class RhythmClip : PlayableAsset, ITimelineClipAsset
	{
		...
		public override Playable CreatePlayable(PlayableGraph graph, GameObject owner)
		{
			...
			//AppLog.Log(owner.GetComponent<PlayableDirector>().time);
	...
	{
		private IRhythmDirector m_RhythmDirector;
		...
		public IRhythmDirector RhythmDirector => m_RhythmDirector;
		...
		public RhythmClipData(RhythmClip rhythmClip, IRhythmDirector rhythmDirector, int trackID, double clipStart, double realDuration)
		{

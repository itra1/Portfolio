...
{
	[PrefabName(DailyMissionType.DestroyHoldNote)]
	public class DestroyHoldNoteMission : Mission
	{
		private IRhythmProcessor _rhythmProcessor;
		private IGameHandler _gameHandler;

		public override string Type => DailyMissionType.DestroyHoldNote;

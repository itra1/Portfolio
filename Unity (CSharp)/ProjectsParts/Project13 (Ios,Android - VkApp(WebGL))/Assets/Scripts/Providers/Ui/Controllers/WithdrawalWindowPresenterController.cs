...
{
	[UiController(WindowPresenterType.Splash, WindowPresenterNames.Withdrawal)]
	public class WithdrawalWindowPresenterController : WindowPresenterController<WithdrawalWindowPresenter>
	{
	}
}

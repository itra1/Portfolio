...
namespace Game.Providers.Ui.Popups.Elements {
	[PrefabName(PopupsNames.YouLoss)]
	internal class YouLossPopup : Popup {
		...
		public override async UniTask Show() {
			...
			System.Action disableAction = async () => {
				_itemsAnimationParent.ItemsAnimationPanel.SpawnItems(FlyingItemName.RoundBot, 1, _dialog, 1);

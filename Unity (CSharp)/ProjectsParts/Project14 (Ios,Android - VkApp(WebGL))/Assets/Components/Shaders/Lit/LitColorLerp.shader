...
Shader "Shaders/Lit/LitColorLerp"
{
	Properties
	{
		_ColorOne("ColorOne", Color) = (1,1,1,1)
		_ColorTwo("ColorTwo", Color) = (0,0,0,1)
	...
	LOD 0
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float cos41 = cos( _RotateGradient );
				float sin41 = sin( _RotateGradient );
				float2 rotator41 = mul( texCoord40 - float2( 0.5,0.5 ) , float2x2( cos41 , -sin41 , sin41 , cos41 )) + float2( 0.5,0.5 );
				float4 lerpResult9 = lerp( _ColorTwo , _ColorOne , rotator41.y);
				
				o.Albedo = (float4( 0,0,0,0 ) + (lerpResult9 - float4( 0,0,0,0 )) * (float4( 1,1,1,1 ) - float4( 0,0,0,0 )) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 ))).rgb;
...
WireConnection;9;2;42;1
WireConnection;47;0;22;0
ASEEND*/
//CHKSM=6729E66D8FC7AB053906FE7BCBF595C6D425E414
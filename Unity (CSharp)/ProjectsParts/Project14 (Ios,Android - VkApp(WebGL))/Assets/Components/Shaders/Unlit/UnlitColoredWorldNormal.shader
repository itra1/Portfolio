...
Shader "Shaders/Unlit/UnlitColoredWorldNormal"
{
	Properties
	{
		_Color("Color", Color) = (1,1,1,1)
		_Shadow("Shadow", Range( -1 , 1)) = 0.2217391
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 lerpResult12 = lerp( lerpResult15 , _Color , ase_worldNormal.y);
...
Node;AmplifyShaderEditor.ColorNode;17;-720,137.5;Inherit;False;Constant;_Color0;Color 0;2;0;Create;True;0;0;0;False;0;False;0.2097778,1,0,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;16;-800,-116.5;Inherit;False;Property;_Shadow;Shadow;1;0;Create;True;0;0;0;False;0;False;0.2217391;0;-1;1;0;1;FLOAT;0
WireConnection;8;0;12;0
WireConnection;12;0;15;0
WireConnection;12;1;11;0
WireConnection;12;2;6;2
WireConnection;15;0;11;0
WireConnection;15;2;16;0
ASEEND*/
//CHKSM=29B42C4B963205FA90FAA9E5AF3F6443C096152D